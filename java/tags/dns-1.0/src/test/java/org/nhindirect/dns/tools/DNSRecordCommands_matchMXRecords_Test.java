...
public class DNSRecordCommands_matchMXRecords_Test extends TestCase 
{
	abstract class TestPlan extends BaseTestPlan 
	{
		...
		protected void performInner() throws Exception
		{
			...
			recordCommands.matchMX(new String[] {matchName});
	...
	{		
		new TestPlan()
		{
			...
			protected List<Record> getRecordsToAdd() throws Exception
			{
				...
				Record recToAdd = new MXRecord(Name.fromString("example.domain.com."), DClass.IN, 3600, 
						1, Name.fromString("mail1.example.domain.com."));
				recordsToAdd.add(recToAdd);
				expectedMatchedRecords.add(recToAdd);			
				
				recToAdd = new MXRecord(Name.fromString("example.domain.com."), DClass.IN, 3600, 
						1, Name.fromString("mail2.example.domain.com."));
				recordsToAdd.add(recToAdd);
				expectedMatchedRecords.add(recToAdd);		
		...
		new TestPlan()
		{
			...
			protected List<Record> getRecordsToAdd() throws Exception
			{
				...
				recordsToAdd.add(new MXRecord(Name.fromString("example2.domain.com."), DClass.IN, 3600, 
						1, Name.fromString("mail1.example2.domain.com.")));
