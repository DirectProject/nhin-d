...
public class DNSRecordCommands_matchARecords_Test extends TestCase 
{
	abstract class TestPlan extends BaseTestPlan 
	{
		...
		protected void performInner() throws Exception
		{
			...
			recordCommands.matchAName(new String[] {matchName});
	...
	{		
		new TestPlan()
		{
			...
			protected void doAssertions(List<Record> recordsMatched) throws Exception		
			{
				...
				assertEquals(2, recordsMatched.size());
	...
	public void testMatchRecords_aRecordsOnly_AssertOnlyARecordMatched() throws Exception 
	{		
		new TestPlan()
		{
			private List<Record> recordsToAdd;
			...
			protected List<Record> getRecordsToAdd() throws Exception
			{
				...
				Record recToAdd = new ARecord(Name.fromString("example.domain.com."), DClass.IN, 3600, InetAddress.getByName("127.0.0.1"));
				recordsToAdd.add(recToAdd);
				expectedMatchedRecords.add(recToAdd);
				
				
				recToAdd = new ARecord(Name.fromString("example.domain.com."), DClass.IN, 3600, InetAddress.getByName("127.0.0.2"));
				recordsToAdd.add(recToAdd);
				expectedMatchedRecords.add(recToAdd);				
	...
	{		
		new TestPlan()
		{
			...
			protected List<Record> getRecordsToAdd() throws Exception
			{
				...
				recordsToAdd.add(new ARecord(Name.fromString("domain.com."), DClass.IN, 3600, InetAddress.getByName("127.0.0.3")));			
