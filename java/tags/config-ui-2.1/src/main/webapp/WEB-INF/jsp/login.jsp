            ...
            <form:form id="loginForm" action="j_spring_security_check" method="PUT">
                ...
                <table border="0" align="center">
                    <tr>
                        ...
                        <td width=200><input type="text" name="j_username" style="width:200px"/></td>
                    </tr>
                    <tr>
                        <td width=75>Password: </td>
                        <td width=200 align=left><input type="password" name="j_password" style="height: 20px; width: 205px"/></td>
                    </tr>
                    <tr>
