                                ...
                                <div class="content no-padding" style="">
                                    <table id="table-domains" class="table" style="width:100%;margin-bottom:0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd">
                                                            <spring:url value="/config/domain?domainName=${domain.domainName}" var="formUrlclick"/>
                                                            <td><form:checkbox path="remove" value="${domain.domainName}" /></td>
                                                            <td><a href='${fn:escapeXml(formUrlclick)}'>${domain.domainName}</a></td>
                                                            <td>${domain.postmasterAddress.emailAddress}</td>
                                                            <td>${domain.status}</td>
