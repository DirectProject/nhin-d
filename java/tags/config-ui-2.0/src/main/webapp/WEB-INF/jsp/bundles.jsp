                    ...
                    <tbody>
                            ...
                            <c:forEach var="trustBundle" items="${trustBundles}" varStatus="rowCounter">
                                <c:choose>
                                    ...
                                    <td><form:checkbox path="bundlesSelected" value="${trustBundle.bundleName}" /></td>
                                    <td><c:out value="${trustBundle.bundleName}"/><br/>
                                        ...
                                        <a rel="leanModal" name="anchorList" href="#anchors_${encodedBundle}">View Anchors</a>
                                        <div id="anchors_${encodedBundle}" class="roundedCorners" style="display:none;background:white;padding:10px;width:350px;height:auto;">
