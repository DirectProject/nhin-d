...
public class CertPolicyResource_disassociatePolicyGroupFromDomainTest 
{
	   ...
	   protected DomainDao domainDao;  
		...
		abstract class TestPlan extends BaseTestPlan 
		{
			...
			{				
				...
				// disassociate
				resource.path("/api/certpolicy/groups/domain/" + TestUtils.uriEscape(getGroupNameToDisassociate()) + "/" + 
						TestUtils.uriEscape(getDomainNameToDisassociate())).delete();
