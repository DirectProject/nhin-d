...
public class TrustBundleResource_updateBundleAttributesTest
{
	   protected TrustBundleDao bundleDao;
		...
		abstract class TestPlan extends BaseTestPlan 
		{
			...
			{				
				...
				resource.path("/api/trustbundle/" + TestUtils.uriEscape(getBundleToUpdate()) + "/bundleAttributes").entity(getBundleDataToUpdate(), MediaType.APPLICATION_JSON).post();
				
				final TrustBundle getBundle = resource.path("/api/trustbundle/" + TestUtils.uriEscape(getBundleUpdatedName())).get(TrustBundle.class);
