...
public class DefaultCertPolicyService_disassociatePolicyGroupFromDomainTest 
{
	...
	{				
		...
		// disassociate
		resource.disassociatePolicyGroupFromDomain(getGroupNameToDisassociate(), getDomainNameToDisassociate());
