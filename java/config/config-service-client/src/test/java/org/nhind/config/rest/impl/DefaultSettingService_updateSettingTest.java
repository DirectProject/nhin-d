...
public class DefaultSettingService_updateSettingTest 
{
	...
	abstract class TestPlan extends BaseTestPlan 
	{
		...
		{				
			...
			try
			{
				resource.updateSetting(getSettingNameToUpdate(), getSettingValueToUpdate());
			}
			catch (ServiceException e)
			{
				throw e;
			...
			final Setting setting = resource.getSetting(getSettingNameToUpdate());
