...
public class DeleteAnchorsByIdsRequest extends AbstractDeleteRequest<Anchor, Anchor>
{
	private final Collection<Long> ids;

    public DeleteAnchorsByIdsRequest(HttpClient httpClient, String certServerUrl,
    ...
    protected String getRequestUri() throws ServiceException
    {
    	...
    	return serviceUrl + "anchor/ids/" + uriEscape(builder.toString());
    }
}