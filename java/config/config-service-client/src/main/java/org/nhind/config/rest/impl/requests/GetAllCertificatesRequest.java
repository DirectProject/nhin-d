...
public class GetAllCertificatesRequest  extends AbstractGetRequest<Certificate>
{
    public GetAllCertificatesRequest(HttpClient httpClient, String certServerUrl,
