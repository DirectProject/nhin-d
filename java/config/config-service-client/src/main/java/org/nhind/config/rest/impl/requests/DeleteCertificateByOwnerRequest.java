...
public class DeleteCertificateByOwnerRequest  extends AbstractDeleteRequest<Certificate, Certificate>
{
	private final String owner;

    public DeleteCertificateByOwnerRequest(HttpClient httpClient, String certServerUrl,
