...
<div id=" class="container">
	...
	<c:if test="${not empty addressesResults}">
		...
		<fieldset style="width: 90%;" title="AddressesGroup">
	...
	<c:if test="${not empty certificateResults}">
		...
		<fieldset style="width: 90%;" title="certificate"><spring:url
			value="/config/domain/addcertificate" var="formUrladdcertificate" /> <form:form
	...
	<c:if test="${not empty anchorResults}">
		<div id="tab3" class="tab_content">
			...
			<legend>Anchors:</legend>
				<fieldset style="width: 90%;" title="anchor"><spring:url value="/config/domain/addanchor" var="formUrladdanchor" /> 
				...
				<form:form  modelAttribute="anchorForm" action="${fn:escapeXml(formUrlremoveanchor)}" cssClass="cleanform" method="POST">
					...
					<button name="submitType" id="submitType" type="submit" value="deleteanchors">Remove Selected</button>
				</form:form>
			</fieldset>
		</fieldset>
		</div>
