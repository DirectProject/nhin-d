...
namespace Health.Direct.Config.Client.DomainManager {
    ...
    public interface ICertPolicyStore {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicies", ReplyAction="urn:directproject:config/store/082010/ICertPolicyStore/GetPoliciesResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(Health.Direct.Config.Store.ConfigStoreFault), Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPoliciesConfigStoreFaul" +
            "tFault", Name="ConfigStoreFault")]
        Health.Direct.Config.Store.CertPolicy[] GetPolicies();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPoliciesByDomain", ReplyAction="urn:directproject:config/store/082010/ICertPolicyStore/GetPoliciesByDomainRespons" +
            "e")]
        [System.ServiceModel.FaultContractAttribute(typeof(Health.Direct.Config.Store.ConfigStoreFault), Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPoliciesByDomainConfigS" +
            "toreFaultFault", Name="ConfigStoreFault")]
        Health.Direct.Config.Store.CertPolicy[] GetPoliciesByDomain(string domain, bool incoming);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicyGroups", ReplyAction="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicyGroupsResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(Health.Direct.Config.Store.ConfigStoreFault), Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicyGroupsConfigStore" +
            "FaultFault", Name="ConfigStoreFault")]
        Health.Direct.Config.Store.CertPolicyGroup[] GetPolicyGroups();
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Health.Direct.Config.Store.ConfigStoreFault), Action="urn:directproject:config/store/082010/ICertPolicyStore/AddPolicyUseToGroupConfigS" +
            "toreFaultFault", Name="ConfigStoreFault")]
        void AddPolicyUseToGroup(long policyGroupId, long policyId, Health.Direct.Config.Store.CertPolicyUse policyUse, bool incoming, bool outgoing);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicyGroupDomainMap", ReplyAction="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicyGroupDomainMapRes" +
            "ponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(Health.Direct.Config.Store.ConfigStoreFault), Action="urn:directproject:config/store/082010/ICertPolicyStore/GetPolicyGroupDomainMapCon" +
            "figStoreFaultFault", Name="ConfigStoreFault")]
        Health.Direct.Config.Store.CertPolicyGroupDomainMap[] GetPolicyGroupDomainMap();
    ...
    public partial class CertPolicyStoreClient : System.ServiceModel.ClientBase<Health.Direct.Config.Client.DomainManager.ICertPolicyStore>, Health.Direct.Config.Client.DomainManager.ICertPolicyStore {
        ...
        public Health.Direct.Config.Store.CertPolicy[] GetPolicies() {
        ...
        public Health.Direct.Config.Store.CertPolicy[] GetPoliciesByDomain(string domain, bool incoming) {
            return base.Channel.GetPoliciesByDomain(domain, incoming);
        }
        ...
        public void UpdatePolicyAttributes(long policyId, string policyName, byte[] policyData, string Description) {
            base.Channel.UpdatePolicyAttributes(policyId, policyName, policyData, Description);
        }
        
        public Health.Direct.Config.Store.CertPolicyGroup[] GetPolicyGroups() {
            return base.Channel.GetPolicyGroups();
        }
        ...
        public void UpdateGroupAttributes(long policyGroupId, string policyGroupName, string Description) {
            base.Channel.UpdateGroupAttributes(policyGroupId, policyGroupName, Description);
        }
        
        public void AddPolicyUseToGroup(long policyGroupId, long policyId, Health.Direct.Config.Store.CertPolicyUse policyUse, bool incoming, bool outgoing) {
            base.Channel.AddPolicyUseToGroup(policyGroupId, policyId, policyUse, incoming, outgoing);
        }
        ...
        public Health.Direct.Config.Store.CertPolicyGroupDomainMap[] GetPolicyGroupDomainMap() {
            return base.Channel.GetPolicyGroupDomainMap();
        }
