...
call :CopyFiles ConfigConsole.exe Health.Direct.Config.Client.dll Health.Direct.Config.Store.dll nhinCommon.dll nhinToolLib.dll ConfigConsoleSettings.xml ConfigConsole.exe.config
exit /b %ERRORLEVEL%
