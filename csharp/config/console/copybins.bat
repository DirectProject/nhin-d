...
call :CopyFiles ConfigConsole.exe Health.Direct.Config.Client.dll Health.Direct.Config.Store.dll nhinCommon.dll Health.Direct.Config.ToolLib.dll ConfigConsoleSettings.xml ConfigConsole.exe.config
exit /b %ERRORLEVEL%
