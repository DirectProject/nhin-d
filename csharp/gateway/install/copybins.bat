...
call :CopyFiles dnsResolver.dll nhinCommon.dll nhinAgent.dll Health.Direct.SmtpAgent.dll Interop.ADODB.dll Interop.CDO.dll %platform_dir%\smtpEventHandler.dll nhinConfigClient.dll nhinConfigStore.dll nhinToolLib.dll nhinConfigConsole.exe ConfigConsoleSettings.xml Nlog.dll Health.Direct.Diagnostics.NLog.dll
exit /b %ERRORLEVEL%
