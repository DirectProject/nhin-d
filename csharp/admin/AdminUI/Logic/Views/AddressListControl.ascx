...
<asp:GridView ID="AddressesGridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
    ForeColor="#333333" GridLines="None" DataKeyNames="ID, DomainID, EmailAddress"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="UpdateDate" DataFormatString="{0:d}" HeaderText="UpdateDate"
            SortExpression="UpdateDate" />
        <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" />
        <asp:CheckBoxField DataField="HasType" HeaderText="HasType" ReadOnly="True" SortExpression="HasType" />
        <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="DetailsButton" runat="server" CommandArgument="<%# Container.DataItemIndex %>"
                    CommandName="Details">Details</asp:LinkButton>
                &nbsp;|
                <asp:LinkButton ID="RemoveButton" runat="server" CommandArgument="<%# Container.DataItemIndex %>"
    ...
    <EmptyDataTemplate>
        <div>
            ...
            <div style="position: relative; top: 0px; left: 0px; width: 43px;">
                <img alt="" src="../../Assets/images/exclamation.png" style="width: 32px; height: 32px" /></div>
        </div>
    </EmptyDataTemplate>
