<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<Certificate>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Certificates for <%= ((Domain)ViewData["Domain"]).Name %></h2>

    <%= Html.ActionLink("Return to domains", "Index", "Domains") %>
    <br />
    
    <%= Html.ActionLink("Add Certificate", "Add", new { domainID = ((Domain)ViewData["Domain"]).ID })%>
    <br />
    <br />
